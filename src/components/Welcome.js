    ...
    if(discordName === "" & window.location.search !== ""){
        ...
        return (
            <Container>
                ...
                {/* <button onClick={() => {window.open("https://discord.com/api/oauth2/authorize?client_id=975582303734607872&redirect_uri=http%3A%2F%2Flocalhost%3A3000&response_type=code&scope=identify", '_self', 'noopener,noreferrer');}}></button> */}
